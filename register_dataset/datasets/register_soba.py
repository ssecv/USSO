...
def register_soba_instances(name, metadata, json_file, image_root):
    ...
    MetadataCatalog.get(name).set(
        json_file=json_file, image_root=image_root, evaluator_type="sobav2", **metadata
    )
...
def register_soba_panoptic_separated(
    ...
    MetadataCatalog.get(semantic_name).set(
        sem_seg_root=sem_seg_root, image_root=image_root, evaluator_type="sobav2", **metadata
    )
